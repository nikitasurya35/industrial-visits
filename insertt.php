...
$sql = "INSERT INTO packagedesc (Username,Mode,TransCost,Accommodation,Acc_Cost,no_of_people,Total_Cost) VALUES ('$username','$mode','$trans_cost','$acc','$acc_cost','$no_of_people','$tots')";
