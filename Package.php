...
<select style="width: 150px; height:50px; font-size: 20px;" onchange="javascript:location.href = this.value">
  <option value="http://localhost/ip/PackageDesc.php">23/10/2019</option>
  <option value="http://localhost/ip/PackageDesc.php">15/11/2019</option>
  <option value="http://localhost/ip/PackageDesc.php">20/12/2019</option>
</select>
